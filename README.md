...
![Prisma](https://img.shields.io/badge/PrismaORM-2D3748?style=for-the-badge&logo=prisma&logoColor=white)
...
Tenho muita **facilidade em me relacionar com as pessoas**, busco dar meu melhor em tudo que faço e estou sempre aberto à críticas e opniões. Sempre disposto a aprender mais e evoluir.
...
- **Task Manager API** - Uma API RESTful robusta e escalável para gerenciamento colaborativo de projetos e tarefas. Desenvolvido usando **TypeScript, Nest.js, Node.js, Prisma ORM, Postgres, RabbitMQ e Docker**.
Veja [Código fonte](https://github.com/developer-gilberto/task-manager-nestjs) e [Deploy](https://task-manager-nestjs-production.up.railway.app/api/v1/docs)
...
- **Instagram**: [@developer.gilberto](https://www.instagram.com/developer.gilberto/)
<!-- 
